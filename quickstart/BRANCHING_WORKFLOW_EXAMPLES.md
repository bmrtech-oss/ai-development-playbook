...
- Full guide: [docs/04-development/branching-strategy.md](../docs/04-development/branching-strategy.md)
- Commit standards: [CONTRIBUTING.md](../docs/CONTRIBUTING.md)
- Feature flags implementation: [Feature Flags in branching-strategy.md](../docs/04-development/branching-strategy.md#feature-flags-for-unfinished-code)
