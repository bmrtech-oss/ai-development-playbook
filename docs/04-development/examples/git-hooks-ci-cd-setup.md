...
This guide helps you set up and configure Git hooks, GitHub Actions, and GitLab CI to enforce the branching strategy outlined in [../branching-strategy.md](../branching-strategy.md).
...
- [Branching Strategy Guide](../branching-strategy.md)
- [Contributing Guidelines](../../CONTRIBUTING.md)
- [Workflow Examples](branching-workflow-examples.md)
...
4. Refer to [Branching Strategy FAQ](../branching-strategy.md#rationale)
